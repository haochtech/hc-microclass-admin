...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_aliyun_upload` (
  ...
  KEY `videoid` (`videoid`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='阿里云点播存储';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_aliyunoss_upload` (
  ...
  KEY `uid` (`uid`),
  KEY `teacherid` (`teacherid`)
) ENGINE=InnoDB AUTO_INCREMENT=694 DEFAULT CHARSET=utf8 COMMENT='阿里云OSS存储';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_article` (
  ...
  KEY `commend` (`commend`),
  KEY `is_vip` (`is_vip`)
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8 COMMENT='文章公告';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='课程属性';
...
) ENGINE=InnoDB AUTO_INCREMENT=440 DEFAULT CHARSET=utf8 COMMENT='图片表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_cashlog` (
  ...
  KEY `idx_addtime` (`addtime`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COMMENT='佣金提现';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=898 DEFAULT CHARSET=utf8 COMMENT='课程分类';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_collect` (
  ...
  KEY `idx_ctype` (`ctype`),
  KEY `idx_addtime` (`addtime`)
) ENGINE=InnoDB AUTO_INCREMENT=4403 DEFAULT CHARSET=utf8 COMMENT='收藏';
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='分销等级';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_commission_log` (
  ...
  KEY `idx_grade` (`grade`),
  KEY `idx_addtime` (`addtime`)
) ENGINE=InnoDB AUTO_INCREMENT=24811 DEFAULT CHARSET=utf8 COMMENT='佣金日志';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_commission_setting` (
  ...
  PRIMARY KEY (`id`),
  KEY `uniacid` (`uniacid`)
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8 COMMENT='分销设置表';
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='限时折扣活动';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_evaluate` (
  ...
  KEY `idx_grade` (`grade`)
) ENGINE=InnoDB AUTO_INCREMENT=628 DEFAULT CHARSET=utf8 COMMENT='评价课程';
...
) ENGINE=InnoDB AUTO_INCREMENT=84 DEFAULT CHARSET=utf8 COMMENT='课程评分';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_history` (
  ...
  KEY `idx_uid` (`uid`),
  KEY `idx_addtime` (`addtime`)
) ENGINE=InnoDB AUTO_INCREMENT=132678 DEFAULT CHARSET=utf8 COMMENT='课程足迹';
...
) ENGINE=InnoDB AUTO_INCREMENT=1819 DEFAULT CHARSET=utf8 COMMENT='首页模块排序';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_inform` (
  ...
  KEY `uniacid` (`uniacid`),
  KEY `lesson_id` (`lesson_id`)
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 COMMENT='课程通知主表';
...
) ENGINE=InnoDB AUTO_INCREMENT=18939 DEFAULT CHARSET=utf8 COMMENT='课程通知粉丝表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_login_pc` (
  ...
  `addtime` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COMMENT='PC端扫码登录';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_member` (
  ...
  KEY `idx_status` (`status`),
  KEY `idx_addtime` (`addtime`)
) ENGINE=InnoDB AUTO_INCREMENT=64255 DEFAULT CHARSET=utf8 COMMENT='会员信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=87403 DEFAULT CHARSET=utf8 COMMENT='会员优惠券';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_member_order` (
  ...
  KEY `idx_addtime` (`addtime`)
) ENGINE=InnoDB AUTO_INCREMENT=5823 DEFAULT CHARSET=utf8 COMMENT='VIP订单';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_member_vip` (
  ...
  KEY `validity` (`validity`)
) ENGINE=InnoDB AUTO_INCREMENT=4328 DEFAULT CHARSET=utf8 COMMENT='已购买VIP';
...
) ENGINE=InnoDB AUTO_INCREMENT=213 DEFAULT CHARSET=utf8 COMMENT='导航表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_order` (
  ...
  KEY `idx_status` (`status`),
  KEY `idx_addtime` (`addtime`)
) ENGINE=InnoDB AUTO_INCREMENT=1000024715 DEFAULT CHARSET=utf8 COMMENT='课程订单';
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='订单核销记录';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_parent` (
  ...
  KEY `vipview` (`vipview`)
) ENGINE=InnoDB AUTO_INCREMENT=1973 DEFAULT CHARSET=utf8 COMMENT='课程主表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_playrecord` (
  ...
  KEY `idx_uid` (`uid`),
  KEY `idx_addtime` (`addtime`)
) ENGINE=InnoDB AUTO_INCREMENT=99061 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='播放记录';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_poster` (
  ...
  PRIMARY KEY (`id`),
  KEY `uniacid` (`uniacid`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COMMENT='分销海报';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_qcloud_upload` (
  ...
  KEY `uid` (`uid`),
  KEY `teacherid` (`teacherid`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='腾讯云存储文件';
...
) ENGINE=InnoDB AUTO_INCREMENT=6012 DEFAULT CHARSET=utf8 COMMENT='七牛上传记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=177 DEFAULT CHARSET=utf8 COMMENT='推荐板块';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_recommend_activity` (
  ...
  KEY `status` (`status`),
  KEY `addtime` (`addtime`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='推广课程免费学习列表';
...
) ENGINE=InnoDB AUTO_INCREMENT=130 DEFAULT CHARSET=utf8 COMMENT='课程推荐下级成员';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_setting` (
  ...
  `lesson_quicknav` tinyint(1) NOT NULL DEFAULT '1' COMMENT '课程详情页快捷导航 0.关闭 1.显示',
  `show_evaluate_time` tinyint(1) NOT NULL DEFAULT '1' COMMENT '课程评价时间 0.隐藏  1.显示',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_uniacid` (`uniacid`)
) ENGINE=InnoDB AUTO_INCREMENT=75 DEFAULT CHARSET=utf8 COMMENT='基本设置';
...
if(!pdo_fieldexists('fy_lesson_setting','lesson_quicknav')) {pdo_query("ALTER TABLE ".tablename('fy_lesson_setting')." ADD   `lesson_quicknav` tinyint(1) NOT NULL DEFAULT '1' COMMENT '课程详情页快捷导航 0.关闭 1.显示'");}
...
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COMMENT='用户签到';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_son` (
  ...
  KEY `idx_parentid` (`parentid`),
  KEY `idx_status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=9533 DEFAULT CHARSET=utf8 COMMENT='课程章节';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_spec` (
  ...
  `addtime` int(11) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`spec_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4879 DEFAULT CHARSET=utf8 COMMENT='课程规格';
...
if(!pdo_fieldexists('fy_lesson_spec','spec_stock')) {pdo_query("ALTER TABLE ".tablename('fy_lesson_spec')." ADD   `spec_stock` int(11) DEFAULT NULL COMMENT '库存'");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_static` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1227 DEFAULT CHARSET=utf8 COMMENT='财务统计';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_study_duration` (
  ...
  KEY `uid` (`uid`),
  KEY `datetime` (`date`)
) ENGINE=InnoDB AUTO_INCREMENT=62740 DEFAULT CHARSET=utf8 COMMENT='会员每日学习时长';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_subscribe_msg` (
  ...
  `update_time` int(11) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=445 DEFAULT CHARSET=utf8 COMMENT='订阅模板消息';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_syslog` (
  ...
  KEY `idx_addtime` (`addtime`)
) ENGINE=InnoDB AUTO_INCREMENT=32874 DEFAULT CHARSET=utf8 COMMENT='操作日志';
...
) ENGINE=InnoDB AUTO_INCREMENT=311 DEFAULT CHARSET=utf8 COMMENT='讲师信息';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_teacher_income` (
  ...
  KEY `idx_bookname` (`bookname`),
  KEY `idx_addtime` (`addtime`)
) ENGINE=InnoDB AUTO_INCREMENT=8755 DEFAULT CHARSET=utf8 COMMENT='讲师收入';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_teacher_order` (
  ...
  KEY `idx_teacherid` (`teacherid`),
  KEY `idx_addtime` (`addtime`)
) ENGINE=InnoDB AUTO_INCREMENT=121 DEFAULT CHARSET=utf8 COMMENT='购买讲师订单表';
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='购买讲师价格';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_title` (
  ...
  KEY `uniacid` (`uniacid`),
  KEY `lesson_id` (`lesson_id`)
) ENGINE=InnoDB AUTO_INCREMENT=612 DEFAULT CHARSET=utf8 COMMENT='课程目录';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_tplmessage` (
  ...
  PRIMARY KEY (`id`),
  KEY `uniacid` (`uniacid`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='模版消息';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_fy_lesson_vip_level` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_is_show` (`is_show`)
) ENGINE=InnoDB AUTO_INCREMENT=143 DEFAULT CHARSET=utf8 COMMENT='VIP等级';
...
) ENGINE=InnoDB AUTO_INCREMENT=10001155 DEFAULT CHARSET=utf8 COMMENT='VIP服务卡';
