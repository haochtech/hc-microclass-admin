...
if($sectionid>0){
	...
	if ($setting['mustinfo']==2 && (!$lesson['lesson_type'] || ($lesson['lesson_type'] && $setting['appoint_mustinfo']))) {
...
if($op=='display'){
	...
	if((!file_exists($imagepath) || time() > filectime($imagepath)+7*86400) && $userAgent){
		$codeArray = array (
